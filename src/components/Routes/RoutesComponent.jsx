...
const RoutesComponent = ({ initialRoutes = [], onRoutesChange }) => {
  ...
  const getStopIcon = (stopNumber, tipo) => {
    ...
    const iconHtml = `
      <div class="route-stop-marker" style="background: #27AE60; color: white; border-radius: 50%; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center; font-weight: bold; border: 2px solid white;">
