...
export const DEMO_ROUTES = [
  ...
  },
  {
    ...
    estado: 'activa',
    paradas: [
      { id: 1, nombre: 'Estacionamiento', latitud: 8.9824, longitud: -79.5502, orden: 1, completada: true, hora_completada: '06:00', tipo: 'inicio' },
      ...
      { id: 4, nombre: 'Estacionamiento', latitud: 8.9824, longitud: -79.5502, orden: 4, completada: false, tipo: 'regreso' }
    ],
    distancia_km: 18.5,
  ...
  },
  {
    ...
    estado: 'activa',
    paradas: [
      { id: 1, nombre: 'Estacionamiento', latitud: 8.9824, longitud: -79.5502, orden: 1, completada: true, hora_completada: '05:30', tipo: 'inicio' },
...
export const DEMO_VEHICLES = [
  ...
  },
  {
    ...
    combustible: 68,
    historialPosiciones: [
      { lat: 8.9824, lng: -79.5502, timestamp: new Date(Date.now() - 12000000).toISOString() },
      { lat: 8.9535, lng: -79.5332, timestamp: new Date(Date.now() - 9000000).toISOString() },
      { lat: 9.0450, lng: -79.4650, timestamp: new Date(Date.now() - 3000000).toISOString() },
      { lat: 9.0200, lng: -79.4850, timestamp: new Date().toISOString() }
    ]
  },
  // Cisternas (2)
  {
  ...
  },
  {
    ...
    combustible: 85,
    historialPosiciones: [
      { lat: 8.9648, lng: -79.5518, timestamp: new Date().toISOString() }
    ]
  },
  {
    id: 'demo-vehicle-16',
    ...
    combustible: 90,
    historialPosiciones: [
      { lat: 8.9654, lng: -79.5524, timestamp: new Date().toISOString() }
    ]
  },
  // Vehículos estacionados en Pueblo Nuevo
  {
    id: 'demo-vehicle-17',
    nombre: 'Compactador 02',
    placa: 'RMP-CC02',
    marca: 'Mercedes-Benz',
    modelo: 'Econic 2630',
    año: 2023,
    ...
    combustible: 75,
    historialPosiciones: [
      { lat: 8.9948, lng: -79.5248, timestamp: new Date().toISOString() }
    ]
  },
  {
    id: 'demo-vehicle-18',
    nombre: 'Camión Carga 02',
    placa: 'RMP-CL02',
    marca: 'Isuzu',
    modelo: 'FTR',
    año: 2022,
    ...
    combustible: 82,
    historialPosiciones: [
      { lat: 8.9952, lng: -79.5252, timestamp: new Date().toISOString() }
    ]
  },
  // Vehículos cerca del Palacio Municipal / Casa de la Municipalidad
  {
    id: 'demo-vehicle-19',
    nombre: 'Bus 25 Pasajeros 03',
    placa: 'RMP-B03',
    marca: 'Mercedes-Benz',
    modelo: 'Sprinter',
    año: 2023,
    ...
    combustible: 88,
    historialPosiciones: [
      { lat: 8.9538, lng: -79.5363, timestamp: new Date().toISOString() }
    ]
  },
  {
    id: 'demo-vehicle-20',
    ...
    combustible: 92,
    historialPosiciones: [
      { lat: 8.9542, lng: -79.5367, timestamp: new Date().toISOString() }
    ]
  },
  // Vehículos estacionados en Estacionamiento Diana Morán 2066
  {
    id: 'demo-vehicle-21',
    nombre: 'Compactador 03',
    placa: 'RMP-CC03',
    marca: 'Volvo',
    modelo: 'FE 280',
    año: 2022,
    ...
    tipoVehiculo: 'compactador',
    tipo_vehiculo: 'compactador',
    capacidad_carga: 11000,
    capacidad_volumen: 11,
    estado: 'Disponible',
    lat: 8.9822,
    lng: -79.5500,
    rutaAsignada: null,
    ...
    combustible: 95,
    historialPosiciones: [
      { lat: 8.9822, lng: -79.5500, timestamp: new Date().toISOString() }
    ]
  },
  {
    id: 'demo-vehicle-22',
    nombre: 'Compactador 04',
    placa: 'RMP-CC04',
    marca: 'Mercedes-Benz',
    modelo: 'Econic 2630',
    año: 2021,
    ...
    combustible: 88,
    historialPosiciones: [
      { lat: 8.9826, lng: -79.5504, timestamp: new Date().toISOString() }
    ]
  },
  {
    id: 'demo-vehicle-23',
    nombre: 'Camión Volteo 01',
    placa: 'RMP-CV01',
    marca: 'Mack',
    modelo: 'Granite',
    año: 2023,
    ...
    combustible: 92,
    historialPosiciones: [
      { lat: 8.9820, lng: -79.5498, timestamp: new Date().toISOString() }
    ]
  },
  {
    id: 'demo-vehicle-24',
    nombre: 'Camión Volteo 02',
    placa: 'RMP-CV02',
    marca: 'Kenworth',
    modelo: 'T880',
    año: 2022,
    ...
    combustible: 85,
    historialPosiciones: [
      { lat: 8.9828, lng: -79.5506, timestamp: new Date().toISOString() }
    ]
  },
  {
    id: 'demo-vehicle-25',
    ...
    combustible: 100,
    historialPosiciones: [
      { lat: 8.9823, lng: -79.5501, timestamp: new Date().toISOString() }
    ]
  },
  {
    id: 'demo-vehicle-26',
    ...
    combustible: 97,
    historialPosiciones: [
      { lat: 8.9827, lng: -79.5505, timestamp: new Date().toISOString() }
    ]
  },
  {
    id: 'demo-vehicle-27',
    ...
    combustible: 90,
    historialPosiciones: [
      { lat: 8.9821, lng: -79.5499, timestamp: new Date().toISOString() }
    ]
  },
  {
    id: 'demo-vehicle-28',
    ...
    combustible: 94,
    historialPosiciones: [
      { lat: 8.9825, lng: -79.5503, timestamp: new Date().toISOString() }
    ]
  }
];
