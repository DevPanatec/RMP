...
export const DEMO_ROUTES = [
  ...
  {
    id: 'demo-ruta-3',
    nombre: 'Recolección Mercado del Marisco',
    tipo_servicio: 'recoleccion',
    descripcion: 'Recolección diaria de residuos en Mercado del Marisco',
    hora_inicio: '06:00',
    hora_fin: '18:00',
    dias_operacion: ['lunes', 'martes', 'miercoles', 'jueves', 'viernes', 'sabado', 'domingo'],
    estado: 'activa',
    paradas: [
      { id: 1, nombre: 'Estacionamiento Diana Moran 2066', latitud: 8.9720, longitud: -79.5380, orden: 1, completada: true, hora_completada: '06:00', tipo: 'inicio' },
      { id: 2, nombre: 'Área de almacenamiento principal', latitud: 8.9670, longitud: -79.5350, orden: 2, completada: true, hora_completada: '06:25' },
      { id: 3, nombre: 'Drenajes y zona trasera de descarga', latitud: 8.9675, longitud: -79.5355, orden: 3, completada: true, hora_completada: '07:40' },
      { id: 4, nombre: 'Área perimetral externa', latitud: 8.9668, longitud: -79.5358, orden: 4, completada: true, hora_completada: '09:15' },
      { id: 5, nombre: 'Área de residuos orgánicos', latitud: 8.9672, longitud: -79.5348, orden: 5, completada: false },
      { id: 6, nombre: 'Entrada principal del mercado', latitud: 8.9665, longitud: -79.5352, orden: 6, completada: false },
      { id: 7, nombre: 'Estacionamiento Diana Moran 2066', latitud: 8.9720, longitud: -79.5380, orden: 7, completada: false, tipo: 'regreso' }
    ],
    distancia_km: 1.5,
...
export const DEMO_VEHICLES = [
  ...
  // Camión compactador para Mercado del Marisco
  {
    ...
    totalParadas: 7,
    ultimaActualizacion: Date.now(),
    horaInicio: Date.now() - (3 * 60 * 60 * 1000 + 15 * 60 * 1000),
    direccion: 180,
    pesoAcumulado: 3200,
    contenedoresRecogidos: 18,
    combustible: 68,
    historialPosiciones: [
      { lat: 8.9720, lng: -79.5380, timestamp: new Date(Date.now() - 11700000).toISOString() },
      { lat: 8.9670, lng: -79.5350, timestamp: new Date(Date.now() - 10800000).toISOString() },
      { lat: 8.9675, lng: -79.5355, timestamp: new Date(Date.now() - 7200000).toISOString() },
      { lat: 8.9668, lng: -79.5358, timestamp: new Date(Date.now() - 3600000).toISOString() },
      { lat: 8.9672, lng: -79.5348, timestamp: new Date().toISOString() }
    ]
  },
